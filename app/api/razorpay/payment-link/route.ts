...
export async function POST(req: NextRequest) {
  try {
    ...
    const paymentLink = await razorpay.paymentLink.create({
      ...
      notes: {
        channel: channel || "HOME_DELIVERY",
        customer_name: cleanName,
        customer_phone: cleanPhone || "N/A",
        customer_email: customerEmail || "N/A",
        order_ref: ref,
        items_summary: itemsSummary || "Fresh Rainbow Trout",
        weight_kg: weightKg !== undefined && weightKg !== null ? String(weightKg) : "",
        product_type: productType ? String(productType) : "",
        rate_per_kg: dealRate !== undefined && dealRate !== null ? String(dealRate) : "",
        standard_rate: standardRate !== undefined && standardRate !== null ? String(standardRate) : "",
        standard_total: standardTotal !== undefined && standardTotal !== null ? String(standardTotal) : "",
        discount_amount: discountAmount !== undefined && discountAmount !== null ? String(discountAmount) : "",
        discount_percent: discountPercent !== undefined && discountPercent !== null ? String(discountPercent) : "",
        custom_notes: notes || "",
      },
